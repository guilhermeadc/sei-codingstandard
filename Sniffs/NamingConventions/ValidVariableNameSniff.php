...
namespace SeiCodingStandard\Sniffs\NamingConventions;
...
class ValidVariableNameSniff extends AbstractVariableSniff
{
    ...
    protected function processVariable(File $phpcsFile, $stackPtr)
    {
            ...
            if ($tokens[$var]['code'] === T_STRING) {
                ...
                if ($tokens[$bracket]['code'] !== T_OPEN_PARENTHESIS) {
                    ...
                    if (Common::isCamelCaps($objVarName, false, true, false) === false) {
                        $error = 'x Member variable "%s" is not in valid camel caps format';
        ...
        if (Common::isCamelCaps($varName, false, true, false) === false) {
            $error = 'x Variable "%s" is not in valid camel caps format';
            $data  = [$originalVarName];
